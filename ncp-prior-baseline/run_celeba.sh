...
# python -m pdb train_celeba.py --datetime $dt --gpu 1 --workers 4 \
#     --data_to_0_1 True --netG $netGpth --netI $netIpth 

# python train_celeba.py --datetime $dt --gpu 1 --workers 4 \
#     --data_to_0_1 True --netG $netGpth --netI $netIpth  > logs/celeba64-$dt.out 2> logs/celeba64-$dt.err
...
python train_celeba.py --mode 'eval' --datetime $dt --gpu 1 --workers 4 \
